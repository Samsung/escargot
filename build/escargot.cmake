...
# so bdwgc reserves a thread-local 4-GiB cage. This condition must
...
IF (ESCARGOT_SMALL_CONFIG)
    SET (LIBSIMDUTF_CXXFLAGS
        ...
        ${CXXFLAGS_FROM_ENV}
        # Force fallback-only single source implementation for small config to save binary space
...
IF (ESCARGOT_ARCH STREQUAL "x86" OR ESCARGOT_ARCH STREQUAL "x64")
    SET (LIBSIMDUTF_CXXFLAGS
        ${LIBSIMDUTF_CXXFLAGS}
        -DSIMDUTF_IMPLEMENTATION_ICELAKE=0
        -DSIMDUTF_IMPLEMENTATION_HASWELL=0
