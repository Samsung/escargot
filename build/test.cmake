...
ADD_CUSTOM_TARGET (run-test262
                   ...
                   COMMAND cd ${PROJECT_SOURCE_DIR}/test/test262/ && TZ="US/Pacific" python ./tools/packaging/test262.py --command ${PROJECT_SOURCE_DIR}/escargot --full-summary
                  )
...
ADD_CUSTOM_TARGET (run-test262-master
                   ...
                   COMMAND python ${PROJECT_SOURCE_DIR}/test/test262-harness-py/src/test262.py --command ${PROJECT_SOURCE_DIR}/escargot --tests=${PROJECT_SOURCE_DIR}/test/test262-master --full-summary
                  )
...
ADD_CUSTOM_TARGET (run-jetstream-only-simple
                   ...
                   COMMAND cd ${PROJECT_SOURCE_DIR}/test/vendortest/JetStream-1.1/; && ./run.sh ${PROJECT_SOURCE_DIR}/escargot simple; && cd -;
                   COMMAND python ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/parsingResults.py ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/jetstream-result-raw.res simple;
...
ADD_CUSTOM_TARGET (run-jetstream-only-cdjs
                   ...
                   COMMAND cp ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/jetstream.runOnePlan.js ${PROJECT_SOURCE_DIR}/test/vendortest/JetStream-1.1/runOnePlan.js
                   COMMAND cp ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/jetstream.run.sh ${PROJECT_SOURCE_DIR}/test/vendortest/JetStream-1.1/run.sh
                   COMMAND cd ${PROJECT_SOURCE_DIR}/test/vendortest/JetStream-1.1/; && ./run.sh ${PROJECT_SOURCE_DIR}/escargot cdjs; && cd -;
                   COMMAND python ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/parsingResults.py ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/jetstream-result-raw.res cdjs;
                   COMMAND ! cat ${PROJECT_SOURCE_DIR}/test/vendortest/driver/jetstream/jetstream-result-raw.res | grep -c 'NaN' > /dev/null;
                  )
