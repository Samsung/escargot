...
#define FOR_EACH_I18N_OP(F)                                                                                                                                                                                                                \
    ...
    F(ucal_getIanaTimeZoneID, int32_t(CALLCONV*)(const UChar* id, int32_t len, UChar* result, int32_t resultCapacity, UErrorCode* status), int32_t)                                                                                        \
    ...
    F(ucal_getTimeZoneTransitionDate, UBool(CALLCONV*)(const UCalendar* cal, UTimeZoneTransitionType type, UDate* transition, UErrorCode* status), UBool)                                                                                  \
    F(ucal_getFieldDifference, int32_t(CALLCONV*)(UCalendar*, UDate, UCalendarDateFields, UErrorCode*), int32_t)                                                                                                                           \
    ...
    F(ures_getInt, int32_t(CALLCONV*)(const UResourceBundle*, UErrorCode*), int32_t)                                                                                                                                                       \
    F(ures_getUInt, uint32_t(CALLCONV*)(const UResourceBundle*, UErrorCode*), uint32_t)                                                                                                                                                    \
...
#define FOR_EACH_I18N_VOID_OP(F)                                                                                                                                            \
    ...
    F(ucal_add, void(CALLCONV*)(UCalendar*, UCalendarDateFields, int32_t, UErrorCode*), void)                                                                               \
    F(ucal_getTimeZoneOffsetFromLocal, void(CALLCONV*)(const UCalendar*, UTimeZoneLocalOption, UTimeZoneLocalOption, int32_t*, int32_t*, UErrorCode*), void)                \
