            ...
            stage('Running test') {
                ...
                parallel (
                    ...
                    '32bit' : {
                        ...
                        sh 'tools/run-tests.py --arch=x86 --engine="${WORKSPACE}/build/out_linux_release/escargot" v8 spidermonkey regression-tests new-es intl test262'
                    },
                    '64bit' : {
                        ...
                        sh 'tools/run-tests.py --arch=x86_64 --engine="${WORKSPACE}/build/out_linux64_release/escargot" v8 spidermonkey regression-tests new-es intl test262'
                    },
                )
            }
        }
