...
static Value builtinTemporalDurationTotal(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_DURATION(duration, Total);
    return Value(Value::DoubleToIntConvertibleTestNeeds, duration->total(state, *argv));
}

static Value builtinTemporalDurationRound(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_DURATION2(duration, round);
    return duration->round(state, *argv);
}
...
static Value builtinTemporalPlainDateToPlainDateTime(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_PLAINDATE(plainDate, ToPlainDateTime);
    return plainDate->toPlainDateTime(state, argc ? argv[0] : Value());
}

static Value builtinTemporalPlainDateToPlainYearMonth(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_PLAINDATE(plainDate, ToPlainYearMonth);
    return plainDate->toPlainYearMonth(state);
}

static Value builtinTemporalPlainDateToPlainMonthDay(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_PLAINDATE(plainDate, ToPlainMonthDay);
    return plainDate->toPlainMonthDay(state);
}

static Value builtinTemporalPlainDateToZonedDateTime(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_PLAINDATE(plainDate, ToZonedDateTime);
    return plainDate->toZonedDateTime(state, argv[0]);
}
...
static Value builtinTemporalZonedDateTimeEpochMilliseconds(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    ...
    return Value(ISO8601::ExactTime(zonedDateTime->epochNanoseconds()).floorEpochMilliseconds());
}
...
static Value builtinTemporalZonedDateTimeToJSON(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME2(zonedDateTime, toJSON);
...
static Value builtinTemporalZonedDateTimeToInstant(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, ToInstant);
    return Value(zonedDateTime->toInstant(state));
}

static Value builtinTemporalZonedDateTimeToPlainDate(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, ToPlainDate);
    return Value(zonedDateTime->toPlainDate(state));
}

static Value builtinTemporalZonedDateTimeToPlainTime(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, ToPlainTime);
    return Value(zonedDateTime->toPlainTime(state));
}

static Value builtinTemporalZonedDateTimeToPlainDateTime(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, ToPlainDateTime);
    return Value(zonedDateTime->toPlainDateTime(state));
}

static Value builtinTemporalZonedDateTimeWith(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME2(zonedDateTime, with);
    return zonedDateTime->with(state, argv[0], argc > 1 ? argv[1] : Value());
}

static Value builtinTemporalZonedDateTimeWithPlainTime(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, WithPlainTime);
    return zonedDateTime->withPlainTime(state, argc ? argv[0] : Value());
}

static Value builtinTemporalZonedDateTimeWithTimeZone(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, WithTimeZone);
    return zonedDateTime->withTimeZone(state, argv[0]);
}

static Value builtinTemporalZonedDateTimeWithCalendar(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, WithCalendar);
    return zonedDateTime->withCalendar(state, argv[0]);
}

static Value builtinTemporalZonedDateTimeAdd(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME2(zonedDateTime, add);
    return zonedDateTime->addDurationToZonedDateTime(state, TemporalZonedDateTimeObject::AddDurationToZonedDateTimeOperation::Add, argv[0], argc > 1 ? argv[1] : Value());
}

static Value builtinTemporalZonedDateTimeSubtract(ExecutionState& state, Value thisValue, size_t argc, Value* argv, Optional<Object*> newTarget)
{
    RESOLVE_THIS_BINDING_TO_ZONEDDATETIME(zonedDateTime, Subtract);
...
void GlobalObject::installTemporal(ExecutionState& state)
{
    ...
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalDurationToString, 0);
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalDurationToJSON, 0);
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalDurationToLocaleString, 0);
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    ...
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->abs, builtinTemporalDurationAbs, 0);
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->with, builtinTemporalDurationWith, 1);
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->add, builtinTemporalDurationAdd, 1);
    ...
    m_temporalDurationPrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyTotal()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyTotal(), builtinTemporalDurationTotal, 1, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalDurationPrototype->defineBuiltinFunction(state, strings->round, builtinTemporalDurationRound, 1);
...
#undef DEFINE_GETTER
    ...
    m_temporalInstantPrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalInstantToString, 0);
    m_temporalInstantPrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    ...
    m_temporalInstantPrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalInstantToJSON, 0);
    m_temporalInstantPrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalInstantToLocaleString, 0);
    m_temporalInstantPrototype->defineBuiltinFunction(state, strings->round, builtinTemporalInstantRound, 1);
    ...
    m_temporalInstantPrototype->defineBuiltinFunction(state, strings->add, builtinTemporalInstantAdd, 1);
    ...
    m_temporalPlainTime->defineBuiltinFunction(state, strings->from, builtinTemporalPlainTimeFrom, 1);
    ...
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalPlainTimeToString, 0);
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalPlainTimeToJSON, 0);
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalPlainTimeToLocaleString, 0);
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->with, builtinTemporalPlainTimeWith, 1);
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->add, builtinTemporalPlainTimeAdd, 1);
    ...
    m_temporalPlainTimePrototype->defineBuiltinFunction(state, strings->round, builtinTemporalPlainTimeRound, 1);
...
#undef DEFINE_PLAINTIME_PROTOTYPE_GETTER_PROPERTY
    ...
    m_temporalPlainDate->defineBuiltinFunction(state, strings->from, builtinTemporalPlainDateFrom, 1);
    ...
    m_temporalPlainDatePrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalPlainDateToString, 0);
    m_temporalPlainDatePrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalPlainDateToJSON, 0);
    m_temporalPlainDatePrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalPlainDateToLocaleString, 0);
    m_temporalPlainDatePrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    ...
    m_temporalPlainDatePrototype->defineBuiltinFunction(state, strings->add, builtinTemporalPlainDateAdd, 1);
    ...
    m_temporalPlainDatePrototype->defineBuiltinFunction(state, strings->with, builtinTemporalPlainDateWith, 1);
    ...
    m_temporalPlainDatePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyToPlainDateTime()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyToPlainDateTime(), builtinTemporalPlainDateToPlainDateTime, 0, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalPlainDatePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyToPlainYearMonth()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyToPlainYearMonth(), builtinTemporalPlainDateToPlainYearMonth, 0, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalPlainDatePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyToPlainMonthDay()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyToPlainMonthDay(), builtinTemporalPlainDateToPlainMonthDay, 0, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalPlainDatePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyToZonedDateTime()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyToZonedDateTime(), builtinTemporalPlainDateToZonedDateTime, 1, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
...
#undef DEFINE_PLAINDATE_PROTOTYPE_EXTRA_GETTER_PROPERTY
    ...
    m_temporalPlainDateTime->defineBuiltinFunction(state, strings->from, builtinTemporalPlainDateTimeFrom, 1);
    ...
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalPlainDateTimeToString, 0);
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalPlainDateTimeToJSON, 0);
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalPlainDateTimeToLocaleString, 0);
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->with, builtinTemporalPlainDateTimeWith, 1);
    ...
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->add, builtinTemporalPlainDateTimeAdd, 1);
    ...
    m_temporalPlainDateTimePrototype->defineBuiltinFunction(state, strings->round, builtinTemporalPlainDateTimeRound, 1);
...
#undef DEFINE_PLAINDATETIME_PROTOTYPE_GETTER_PROPERTY
    ...
    m_temporalPlainYearMonth->defineBuiltinFunction(state, strings->from, builtinTemporalPlainYearMonthFrom, 1);
    ...
    m_temporalPlainYearMonthPrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalPlainYearMonthToString, 0);
    m_temporalPlainYearMonthPrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalPlainYearMonthToJSON, 0);
    m_temporalPlainYearMonthPrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalPlainYearMonthToLocaleString, 0);
    m_temporalPlainYearMonthPrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    m_temporalPlainYearMonthPrototype->defineBuiltinFunction(state, strings->with, builtinTemporalPlainYearMonthWith, 1);
    ...
    m_temporalPlainYearMonthPrototype->defineBuiltinFunction(state, strings->add, builtinTemporalPlainYearMonthAdd, 1);
...
#undef DEFINE_PLAINYEARMONTH_PROTOTYPE_EXTRA_GETTER_PROPERTY
    ...
    m_temporalPlainMonthDay->defineBuiltinFunction(state, strings->from, builtinTemporalPlainMonthDayFrom, 1);
    ...
    m_temporalPlainMonthDayPrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalPlainMonthDayToString, 0);
    m_temporalPlainMonthDayPrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalPlainMonthDayToJSON, 0);
    m_temporalPlainMonthDayPrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalPlainMonthDayToLocaleString, 0);
    m_temporalPlainMonthDayPrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    m_temporalPlainMonthDayPrototype->defineBuiltinFunction(state, strings->with, builtinTemporalPlainMonthDayWith, 1);
    ...
    m_temporalZonedDateTime->defineBuiltinFunction(state, strings->from, builtinTemporalZonedDateTimeFrom, 1);
    ...
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->toString, builtinTemporalZonedDateTimeToString, 0);
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->toJSON, builtinTemporalZonedDateTimeToJSON, 0);
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->toLocaleString, builtinTemporalZonedDateTimeToLocaleString, 0);
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->valueOf, builtinTemporalAnyInstanceValueOf, 0);
    ...
    m_temporalZonedDateTimePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyToPlainTime()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyToPlainTime(), builtinTemporalZonedDateTimeToPlainTime, 0, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalZonedDateTimePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyToPlainDateTime()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyToPlainDateTime(), builtinTemporalZonedDateTimeToPlainDateTime, 0, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->with, builtinTemporalZonedDateTimeWith, 1);
    m_temporalZonedDateTimePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyWithPlainTime()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyWithPlainTime(), builtinTemporalZonedDateTimeWithPlainTime, 0, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    m_temporalZonedDateTimePrototype->directDefineOwnProperty(state, ObjectPropertyName(strings->lazyWithTimeZone()), ObjectPropertyDescriptor(new NativeFunctionObject(state, NativeFunctionInfo(strings->lazyWithTimeZone(), builtinTemporalZonedDateTimeWithTimeZone, 1, NativeFunctionInfo::Strict)), (ObjectPropertyDescriptor::PresentAttribute)(ObjectPropertyDescriptor::WritablePresent | ObjectPropertyDescriptor::ConfigurablePresent)));
    ...
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->add, builtinTemporalZonedDateTimeAdd, 1);
    ...
    m_temporalZonedDateTimePrototype->defineBuiltinFunction(state, strings->round, builtinTemporalZonedDateTimeRound, 1);
