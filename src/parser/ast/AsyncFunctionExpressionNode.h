...
#ifndef AsyncFunctionExpressionNode_h
#define AsyncFunctionExpressionNode_h

namespace Escargot {

class AsyncFunctionExpressionNode : public ExpressionNode {
public:
    AsyncFunctionExpressionNode(size_t subCodeBlockIndex, const AtomicString& functionName)
    ...
    virtual ASTNodeType type() override { return ASTNodeType::AsyncFunctionExpression; }
