...
#ifndef AssingmentExpressionExponentiationNode_h
#define AssingmentExpressionExponentiationNode_h
...
class AssingmentExpressionExponentiationNode : public ExpressionNode {
public:
    friend class ScriptParser;

    AssingmentExpressionExponentiationNode(Node* left, Node* right)
        : ExpressionNode()
        , m_left(left)
        , m_right(right)
    {
    ...
    virtual ~AssingmentExpressionExponentiationNode()
    {
    }

    virtual ASTNodeType type() { return ASTNodeType::AssignmentExpressionExponentiation; }
