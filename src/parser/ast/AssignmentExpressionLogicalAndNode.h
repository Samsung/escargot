...
#ifndef AssignmentExpressionLogicalAndNode_h
#define AssignmentExpressionLogicalAndNode_h
...
class AssignmentExpressionLogicalAndNode : public AssignmentExpressionNode {
public:
    AssignmentExpressionLogicalAndNode(Node* left, Node* right)
        : AssignmentExpressionNode(left, right)
    {
    }

    virtual ASTNodeType type() override { return ASTNodeType::AssignmentExpressionLogicalAnd; }
    virtual void generateExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context, ByteCodeRegisterIndex dstRegister) override
    {
        ...
        codeBlock->pushCode<JumpIfBoolean>(JumpIfBoolean(ByteCodeLOC(m_loc.index), true, src0), context, this->m_loc.index);
