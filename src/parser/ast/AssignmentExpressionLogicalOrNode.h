...
#ifndef AssignmentExpressionLogicalOrNode_h
#define AssignmentExpressionLogicalOrNode_h
...
class AssignmentExpressionLogicalOrNode : public ExpressionNode {
public:
    AssignmentExpressionLogicalOrNode(Node* left, Node* right)
        : ExpressionNode()
        , m_left(left)
        , m_right(right)
    {
    ...
    virtual ASTNodeType type() override { return ASTNodeType::AssignmentExpressionLogicalOr; }
    virtual void generateExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context, ByteCodeRegisterIndex dstRegister) override
    {
        ...
        codeBlock->pushCode<JumpIfTrue>(JumpIfTrue(ByteCodeLOC(m_loc.index), src0), context, this);
