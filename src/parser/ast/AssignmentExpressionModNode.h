...
class AssignmentExpressionModNode : public AssignmentExpressionNode {
public:
    ...
    virtual void generateExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context, ByteCodeRegisterIndex dstRegister) override
    {
        ...
        context->giveUpRegister();
        codeBlock->pushCode(BinaryMod(ByteCodeLOC(m_loc.index), src0, src1, dstRegister), context, this->m_loc.index);
