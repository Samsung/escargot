...
public:
    ...
    virtual void generateExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context, ByteCodeRegisterIndex dstRegister) override
    {
        ...
        codeBlock->pushCode(Decrement(ByteCodeLOC(m_loc.index), srcIndex, storeIndex, dstRegister), context, this->m_loc.index);
    ...
    virtual void generateResultNotRequiredExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context) override
    {
        ...
        codeBlock->pushCode(Decrement(ByteCodeLOC(m_loc.index), argumentSrc, resultIndex), context, this->m_loc.index);
        context->giveUpRegister();
