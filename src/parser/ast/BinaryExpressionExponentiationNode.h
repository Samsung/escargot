...
#ifndef BinaryExpressionExponentiation_h
#define BinaryExpressionExponentiation_h

#include "ExpressionNode.h"

namespace Escargot {

class BinaryExpressionExponentiationNode : public ExpressionNode {
public:
    BinaryExpressionExponentiationNode(Node* left, Node* right)
        : ExpressionNode()
    ...
    virtual ~BinaryExpressionExponentiationNode()
    {
    }

    virtual ASTNodeType type() { return ASTNodeType::BinaryExpressionExponentiation; }
