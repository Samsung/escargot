...
#ifndef BinaryExpressionExponentiationNode_h
#define BinaryExpressionExponentiationNode_h
...
public:
    ...
    virtual ASTNodeType type() override { return ASTNodeType::BinaryExpressionExponentiation; }
