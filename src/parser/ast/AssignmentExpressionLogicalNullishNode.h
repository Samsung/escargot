...
#ifndef AssignmentExpressionLogicalNullishNode_h
#define AssignmentExpressionLogicalNullishNode_h
...
class AssignmentExpressionLogicalNullishNode : public AssignmentExpressionNode {
public:
    AssignmentExpressionLogicalNullishNode(Node* left, Node* right)
        : AssignmentExpressionNode(left, right)
    {
    }

    virtual ASTNodeType type() override { return ASTNodeType::AssignmentExpressionLogicalNullish; }
    virtual void generateExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context, ByteCodeRegisterIndex dstRegister) override
    {
        ...
        codeBlock->pushCode<JumpIfUndefinedOrNull>(JumpIfUndefinedOrNull(ByteCodeLOC(m_loc.index), true, src0), context, this->m_loc.index);
