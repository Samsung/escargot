...
public:
    ...
    virtual ASTNodeType type() { return ASTNodeType::BinaryExpressionBitwiseXor; }
    virtual void generateExpressionByteCode(ByteCodeBlock* codeBlock, ByteCodeGenerateContext* context, ByteCodeRegisterIndex dstRegister)
    {
        ...
        codeBlock->pushCode(BinaryBitwiseXor(ByteCodeLOC(m_loc.index), src0, src1, dstRegister), context, this);
