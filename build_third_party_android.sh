...
GCCONFFLAGS_COMMON=" --enable-munmap --disable-parallel-mark --enable-large-config --disable-parallel-mark --enable-thread " # --enable-thread --enable-pthread --enable-large-config --enable-cplusplus"
